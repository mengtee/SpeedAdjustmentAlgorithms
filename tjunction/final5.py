''''after passing the junction, some of the vehicle will still brakes
if the vehicle in front brakes too fast, the vehicle behind might be collide: solution sort by vehicle that reaching the junction first'''
import optparse
import os
import sys
import math
    ...
    for t in range(1, horizon):
        for other_vehicle in vehicles:
            ...
            if time_to_junction > other_time_to_junction:
                ...
                # print(f'This is the horizon {t} for {vehicle_id}, and the collision time {collision_time}')
...
'''Performance
tjunction_02: 6 vehicle collision, with 47 steps
tjunction_03: 12 step with 0 collision'''